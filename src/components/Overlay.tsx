...
export default function Overlay(props: {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-between p-4">
      ...
      >
        <div>
          <h2 className="text-white/80 text-xl font-light tracking-wider">
            Galaxy of Love
          </h2>
        </div>
        ...
        <button
          ...
          className="text-white/60 hover:text-love-pink transition-colors p-1"
        >
          {muted ? (
        ...
        {props.selectedMemory && (
          ...
          >
            ...
            >
              {/* @ts-ignore */}
              <img
                src={props.selectedMemory.image}
                alt="Memory"
                className="w-full h-64 object-cover rounded-lg mb-6 border border-white/10"
              />

              <h3 className="text-2xl text-love-pink font-light tracking-widest mb-4">
                MEMORY
              </h3>
              {/* @ts-ignore */}
              <p className="text-white/90 text-lg leading-relaxed font-serif italic">
                "{props.selectedMemory.message}"
              </p>
